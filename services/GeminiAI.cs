...
public class GeminiService : IGeminiService
{
        ...
        string? prompt = null)
    {
        ...
        {
            instruction =
                "Use as duas imagens fornecidas: a primeira é a pessoa e a segunda é o produto ocular. Faça uma edição realista mantendo pose, expressão facial, roupas, iluminação, proporções e aparência natural do produto.";
        }
